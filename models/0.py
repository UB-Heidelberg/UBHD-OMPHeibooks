...
settings.title = 'heiBOOKS'
settings.subtitle = ''
settings.author_email = 'heiup@ub.uni-heidelberg.de'
settings.keywords = 'heiBOOKS,Universitätsbibliothek Heidelberg, Universität Heidelberg, digitales Publizieren, Open Access, omp, python, mysql, knv, onix, arthistoricum'
settings.description = 'heiBOOKS'
